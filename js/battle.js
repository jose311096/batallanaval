...
//Jugada del PC esta funcion se conecta al servidor para recibir las jugadas de la maquina
function shotPc(){

    let url = 'http://localhost:8001/pc';
	...
	api.onreadystatechange = function(){
		...
		if(this.status == 200 && this.readyState == 4){
            ...
            if(matrix[x][y] === "ship"){
                document.getElementById("descripcion").innerHTML = "Ops! te han disparado";
                matrix[x][y] = "hit";
                ...
                document.getElementById("descripcion").innerHTML = "El disparo del pc cayó al agua";
                matrix[x][y] = "miss";
